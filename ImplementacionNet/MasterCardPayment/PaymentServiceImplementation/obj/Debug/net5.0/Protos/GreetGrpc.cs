...
namespace PaymentServiceContract {
  ...
  public static partial class Payer
  {
    ...
    {
      get { return global::PaymentServiceContract.GreetReflection.Descriptor.Services[0]; }
    }
    ...
    public abstract partial class PayerBase
    {
      ...
      public virtual global::System.Threading.Tasks.Task<global::PaymentServiceContract.HelloReply> SayHello(global::PaymentServiceContract.HelloRequest request, grpc::ServerCallContext context)
      {
    ...
    {
      serviceBinder.AddMethod(__Method_SayHello, serviceImpl == null ? null : new grpc::UnaryServerMethod<global::PaymentServiceContract.HelloRequest, global::PaymentServiceContract.HelloReply>(serviceImpl.SayHello));
    }
