...
public class ObtenerCatalogoFranquiciaBean {
	...
	public ObtenerCatalogoFranquiciaBean() {
	}

	public ArrayList<Producto> obtenerCatalogoFranquicia(String idFranquicia) {
		try {
			Client client = ClientBuilder.newClient();
			ArrayList<Producto> productos = client
                    .target("http://25.43.202.212:8080/servicio-catalogo/catalogo/"+idFranquicia)
